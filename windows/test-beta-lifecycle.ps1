...
if ([string]::IsNullOrWhiteSpace($ArchivePath)) { $ArchivePath = Join-Path $PSScriptRoot 'dist\MyVibe-0.5.0-beta.1-win-x64.zip' }
...
try {
    ...
    if ($version -ne '0.5.0.0') { throw "Unexpected MyVibe file version: $version" }
