...
enum Registry {
    static let products = [
        ...
        RegistryProduct(id: "com.badru.tonemesh", name: "ToneMesh", version: "0.9.3", description: "Editable tone-driven vector fields for Adobe Illustrator.", nativeName: "ToneMesh.aip", cepName: "ToneMesh")
    ]
